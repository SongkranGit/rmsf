...
| <input type="button" href="../responsive-filemanager/dialog.php?field_id=imgField&lang=en_EN&akey=myPrivateKey" value="Files">
| in tinymce a new parameter added: filemanager_access_key:"myPrivateKey"
| example tinymce config:
|
| tiny init ...
| external_filemanager_path:"../responsive-filemanager/",
...
$folder_website = "/studypluscenter.com/public_html";
...
$config = array(
    ...
    */
    ...
    /*
    |--------------------------------------------------------------------------
    | relative path from responsive-filemanager folder to upload folder
    |--------------------------------------------------------------------------
    |
    | with final /
    |
    */
    ...
    /*
    |--------------------------------------------------------------------------
    | relative path from responsive-filemanager folder to thumbs folder
    |--------------------------------------------------------------------------
    |
    | with final /
    ...
    */
    ...
    | Can be set to custom icon inside responsive-filemanager/img
    |
    */
    'icon_theme' => "ico",


    //Show or not total size in responsive-filemanager (is possible to greatly increase the calculations)
    'show_total_size' => false,
    //Show or not show folder size in list view feature in responsive-filemanager (is possible, if there is a large folder, to greatly increase the calculations)
    'show_folder_size' => false,
    //Show or not show sorting feature in responsive-filemanager
    'show_sorting_bar' => true,
    //Show or not show filters button in responsive-filemanager
    'show_filter_buttons' => true,
    //Show or not language selection feature in responsive-filemanager
    ...
    */
    ...
    //file in a folder the javascript script can't sort all or filter all, so the responsive-filemanager switch to php script.
    ...
    // New image resized creation with fixed path from responsive-filemanager folder after uploading (thumbnails in fixed mode)
    ...
    //
    'fixed_image_creation' => false, //activate or not the creation of one or more image resized with fixed path from responsive-filemanager folder
    ...
    */
    ...
    // With Responsive responsive-filemanager you can create automatically resized image inside the upload folder, also more than one at a time
    ...
    */
    ...
    // Remember text filter after close responsive-filemanager for future session
